...
const Footer = () => {
  return (
    <div className="flex justify-center bg-[#175dff4f] text-white">
      <footer className="relative z-10 p-4">
        <div className="container">
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="w-full mb-10">
                <a href="/#" className="mb-6 inline-block max-w-[500px]">
                  <img src={VBC} alt="logo" className="max-w-full" />
                </a>
                <p class="footer-company-intro">
                  <span>Vietnam Blockchain Corporation</span> - A leading
                  pioneer of the Blockchain field in Vietnam aims to create new
                  value for high quality Vietnamese branded products.
                </p>
              </div>
            </div>
