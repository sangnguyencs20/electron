...
const TimeLineTable = ({ receiver }) => {
  const items = [
    {
      ...
      media: {
        type: "IMAGE",
        source: {
          url: "https://images.unsplash.com/photo-1682685797660-3d847763208e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
        },
      },
    },
    {
  ...
  return (
    <Container fluid css={{ height: "700px" }}>
      <Chrono
        items={items}
